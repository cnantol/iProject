...
export default function CommissionPage() {
  ...
  const orderTypeChip = (type) => {
    if (!type) return null;
    const colors = { A: '#1976D2', B: '#2E7D32', C: '#C9A227' };
    const color = colors[type] || '#78909C';
    return (
      <Chip size="small" label={type} sx={{ height: 22, minWidth: 28, borderRadius: 1.5, fontWeight: 800, fontSize: 12,
        color, bgcolor: color + '1F', border: '1px solid ' + color + '66' }} />
    );
  };
